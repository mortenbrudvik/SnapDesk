...
enum AccessibilityAuth {
    ...
    static func showRelaunchAlert() {
        let alert = NSAlert()
        alert.messageText = "SnapDesk needs Accessibility"
    ...
    static func relaunch() {
        ...
        do {
            ...
            let alert = NSAlert()
            alert.messageText = "SnapDesk could not relaunch itself"
            alert.informativeText = "Quit SnapDesk and open it again from Applications.\n\n\(error.localizedDescription)"
            alert.runModal()
            return
        }
        NSApp.terminate(nil)
